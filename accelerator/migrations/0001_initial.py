    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interest_categories', models.ManyToManyField(
                    ...
                    to=swapper.get_model_name('accelerator',
                                              'INTERESTCATEGORY'),
                    db_table='accelerator_memberprofile_interest_categories',
                )
                 ),
                ('program_families', models.ManyToManyField(
                    blank=True,
                    help_text='Which of our Program Families would you like to'
                              ' be involved with?',
                    related_name='interested_memberprofile',
                    to=swapper.get_model_name(
                        'accelerator',
                        'PROGRAMFAMILY'),
                    db_table='accelerator_memberprofile_program_families')),
                ('recommendation_tags', models.ManyToManyField(
                    blank=True,
                    to=swapper.get_model_name(
                        'accelerator',
                        'RECOMMENDATIONTAG'),
                    db_table='accelerator_memberprofile_recommendation_tags')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applications', models.ManyToManyField(related_name='panels',
                                                        through=swapper.get_model_name(
                                                            'accelerator',
                                                            'ApplicationPanelAssignment'),
                                                        to=swapper.get_model_name(
                                                            'accelerator',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                db_table='accelerator_expertprofile_interest_categories',
            ),
        ),
        migrations.AddField(
            model_name='expertprofile',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True,
                                         ...
                                         db_table='accelerator_expertprofile_program_families',
                                         ),
        ),
        migrations.AddField(
            model_name='expertprofile',
            ...
            field=models.ManyToManyField(blank=True,
                                         to=swapper.get_model_name(
                                             'accelerator',
                                             'RECOMMENDATIONTAG'),
                                         db_table='accelerator_expertprofile_recommendation_tags'),
        ),
        migrations.AddField(
            model_name='expertprofile',
            name='user',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True,
                to=swapper.get_model_name('accelerator', 'INTERESTCATEGORY'),
                db_table='accelerator_entrepreneurprofile_interest_categories'
            ),
        ),
        migrations.AddField(
            model_name='entrepreneurprofile',
            ...
            field=models.ManyToManyField(blank=True,
                                         ...
                                         to=swapper.get_model_name(
                                             'accelerator', 'PROGRAMFAMILY'),
                                         db_table='accelerator_entrepreneurprofile_program_families'),
        ),
        migrations.AddField(
            model_name='entrepreneurprofile',
            name='recommendation_tags',
            field=models.ManyToManyField(blank=True,
                                         to=swapper.get_model_name(
                                             'accelerator',
                                             'RECOMMENDATIONTAG'),
                                         db_table='accelerator_entrepreneurprofile_recommendation_tags'),
        ),
        migrations.AddField(
            model_name='entrepreneurprofile',
            name='user',
