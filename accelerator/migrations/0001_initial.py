    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'APPLICATIONPANELASSIGNMENT'),
            },
        ),
        migrations.CreateModel(
            name='BucketState',
            fields=[
                ...
                ('created_at',
                 models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('name', models.CharField(blank=True, choices=[
                    ('stale_nostartup', 'Old Entrepreneurs'),
                    ('stale_startup', 'Old Startups'),
                    ('new_entrepreneurs', 'New Entrepreneurs'),
                    ('unpaid', 'Active Unpaid Startups'),
                    ('unsubmitted', 'Working on Application'),
                    ('submitted', 'Has Submitted Application'),
                    ('new_experts', 'New Experts')], default='unsubmitted',
                ...
                ('cycle',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to=swapper.get_model_name('accelerator', 'PROGRAMCYCLE'))),
            ],
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'BUCKETSTATE'),
            },
        ),
        migrations.CreateModel(
            name='Clearance',
            fields=[
                ...
                ('created_at',
                 models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('level', models.CharField(choices=[('Exec/MD', 'Exec/MD'), (
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'CLEARANCE'),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_program', models.ForeignKey(blank=True, null=True,
                                                      on_delete=django.db.models.deletion.CASCADE,
                                                      to=swapper.get_model_name('accelerator', 'PROGRAM'))),
            ],
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'ENTREPRENEURPROFILE'),
            },
        ),
        migrations.CreateModel(
            name='ExpertCategory',
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'EXPERTCATEGORY'),
            },
        ),
        migrations.CreateModel(
            name='ExpertProfile',
            fields=[
                ...
                ('public_website_consent', models.BooleanField(default=False,
                                                               verbose_name='Public Website Consent')),
                ('public_website_consent_checked',
                 models.BooleanField(default=False,
                                     verbose_name='Public Website Consent Check')),
                ('judge_interest', models.BooleanField(default=False,
                                                       help_text='I would like to participate in MassChallenge as a Judge',
                                                       verbose_name='Judge')),
                ('mentor_interest', models.BooleanField(default=False,
                                                        help_text='I would like to participate in MassChallenge as a Mentor',
                                                        verbose_name='Mentor')),
                ('speaker_interest', models.BooleanField(default=False,
                                                         help_text='I would like to participate in MassChallenge as a Speaker',
                                                         verbose_name='Speaker')),
                ('speaker_topics', models.TextField(blank=True,
                                                    help_text='Please describe the topic(s) you would be available to speak about',
                                                    verbose_name='Speaker Topics')),
                ('office_hours_interest', models.BooleanField(default=False,
                                                              help_text='I would like to participate in MassChallenge by holding Office Hours',
                                                              verbose_name='Office Hours')),
                ('office_hours_topics', models.TextField(blank=True,
                                                         help_text='Please describe the topic(s) you would be available to speak to Finalists about during Office Hours',
                                                         verbose_name='Office Hour Topics')),
                ('expert_group', models.CharField(blank=True, max_length=10,
                                                  verbose_name='Expert Group')),
                ('reliability',
                 models.DecimalField(blank=True, decimal_places=2,
                                     default=Decimal('1.00'), max_digits=3,
                                     null=True)),
                ('referred_by', models.TextField(blank=True,
                                                 help_text='If someone referred you to MassChallenge, please provide their name (and organization if relevant). Otherwise, please indicate how you learned about the opportunity to participate at MassChallenge (helps us understand the effectiveness of our outreach programs).',
                                                 max_length=500)),
                ('other_potential_experts', models.TextField(blank=True,
                                                             help_text="We're always looking for more great experts to join the MassChallenge community and program. We welcome the names and contact info (email) of individuals you think could be great additions to the program, as well as how you think they might want to be involved (Judge, Mentor, etc.) Also, please encourage these individuals to fill out their own Expert Profile.",
                                                             max_length=500)),
                ('internal_notes', models.TextField(blank=True,
                                                    help_text='Internal notes only for use by MassChallenge Staff (not visible to Expert)',
                                                    max_length=500)),
                ('bio', models.TextField(blank=True, default='')),
            ],
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'EXPERTPROFILE'),
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'INTERESTCATEGORY'),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at',
                 models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('judging_status', models.IntegerField(blank=True, choices=[
                    (1, 'No Conflict'),
                    (2, 'Not Judged - Conflict of Interest'),
                    (3, 'Not Judged - Other (eg., no show)')], null=True)),
                ('feedback_status', models.CharField(
                    choices=[('COMPLETE', 'COMPLETE'),
                             ('INCOMPLETE', 'INCOMPLETE'),
                             ('NOT-JUDGED-CONFLICT', 'NOT JUDGED, CONFLICT'),
                             ('NOT-JUDGED-OTHER', 'NOT JUDGED, OTHER')],
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'JUDGEAPPLICATIONFEEDBACK'),
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'JUDGEAVAILABILITY'),
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'JUDGEFEEDBACKCOMPONENT'),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at',
                 models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('assignment_status', models.CharField(blank=True, choices=[
                    ('ASSIGNED', 'ASSIGNED'), ('COMPLETE', 'COMPLETE')],
                                                       default='',
                                                       max_length=16)),
                ('panel_sequence_number',
                 models.PositiveIntegerField(blank=True,
                                             help_text='Indicate in which order this panel should be completed by this judge',
                                             null=True)),
                ('judge',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to=settings.AUTH_USER_MODEL)),
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'JUDGEPANELASSIGNMENT'),
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'JUDGEROUNDCOMMITMENT'),
            },
        ),
        migrations.CreateModel(
            name='JudgingForm',
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'JUDGINGFORM'),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('element_type', models.CharField(
                    choices=[('answer', 'Application Answer'),
                             ('boilerplate', 'Boilerplate'),
                             ('feedback', 'Feedback')], max_length=64)),
                ('feedback_type', models.CharField(blank=True, choices=[
                    ('multiline', 'MultilineText'),
                    ('multichoice', 'MultipleChoice'), ('number', 'Number')],
                                                   max_length=64)),
                ('display_value', models.CharField(
                    choices=[('omit', 'Omit'), ('value', 'Value'),
                             ('yesno', 'Yes/No')], max_length=64)),
                ...
                ('text_minimum',
                 models.IntegerField(blank=True, default=0, null=True)),
                ('text_minimum_units', models.CharField(blank=True, choices=[
                    ('characters', 'Characters'), ('words', 'Words')],
                                                        max_length=64)),
                ('choice_options',
                 models.CharField(blank=True, max_length=200)),
                ('choice_layout', models.CharField(blank=True, choices=[
                    ('horizontal', 'Horizontal'), ('vertical', 'Vertical'),
                    ('dropdown', 'Dropdown')], max_length=64)),
                ('sharing', models.CharField(blank=True, choices=[
                    ('share-with-startup', 'Share with Startup'), (
                    'administrator-only',
                    'Share with Program Administrators')], max_length=64)),
                ('application_question',
                 models.ForeignKey(blank=True, null=True,
                                   on_delete=django.db.models.deletion.CASCADE,
                                   to=swapper.get_model_name('accelerator', 'APPLICATIONQUESTION'))),
                ('form_type',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to=swapper.get_model_name('accelerator', 'JUDGINGFORM'))),
            ],
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'JUDGINGFORMELEMENT'),
            },
        ),
        migrations.CreateModel(
            name='JudgingRound',
            fields=[
                ...
                ('created_at',
                 models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('cycle_based_round', models.BooleanField(default=False,
                ...
                ('buffer_before_event', models.IntegerField(
                    choices=[(0, 0), (15, 15), (30, 30), (45, 45), (60, 60),
                             (75, 75), (90, 90), (105, 105), (120, 120)],
                    default=30,
                    help_text='Choose a time in increments of 15 minutes.')),
                ('recruit_judges', models.CharField(choices=[('NO',
                                                              'Do not recruit judges or display prior commitments'),
                                                             ('ANYONE',
                                                              'Recruit any expert'),
                                                             ('APPROVEDONLY',
                                                              'Recruit only approved judges'),
                                                             ('DISPLAYONLY',
                                                              'Only display judges prior commitments')],
                                                    default='NO',
                                                    max_length=16)),
                ('recruiting_prompt', models.TextField(blank=True,
                                                       help_text='You may use HTML, including links')),
                ('positive_recruiting_prompt', models.TextField(blank=True,
                                                                help_text='You may use HTML, including links',
                                                                verbose_name='Positive Recruiting Response Label')),
                ('negative_recruiting_prompt', models.TextField(blank=True,
                                                                help_text='You may use HTML, including links',
                                                                verbose_name='Negative Recruiting Response Label')),
                ('capture_capacity', models.BooleanField(default=False)),
                ('capacity_prompt', models.TextField(blank=True,
                                                     help_text='You may use HTML, including links')),
                ('capacity_options', models.CharField(blank=True,
                                                      help_text="Provide a list of integers, separated by '|' (like 10|20|30)",
                                                      max_length=255,
                                                      validators=[
                                                          accelerator_abstract.models.base_judging_round.validate_capacity_options])),
                ('capture_availability', models.CharField(
                    choices=[('disabled', 'Disabled'),
                             ('location-only', 'Capture location only'),
                             ('time-only', 'Capture time only'),
                             ('type-only', 'Capture type only')],
                    default='disabled', max_length=32)),
                ('feedback_display', models.CharField(
                    choices=[('disabled', 'Disabled'), ('enabled', 'Enabled')],
                    default='disabled', max_length=10)),
                ('feedback_display_message', models.TextField(blank=True,
                                                              help_text='You may use HTML, including links (not relevant if merged with another round)')),
                ('feedback_display_items', models.CharField(blank=True,
                                                            choices=[(
                                                                     'feedback-and-judge-category',
                                                                     'Judge Category and Feedback'),
                                                                     (
                                                                     'feedback-only',
                                                                     'Only Feedback'),
                                                                     (
                                                            ...
                                                            max_length=64)),
                ('judge_instructions', models.TextField(blank=True,
                                                        help_text='Instructions to present to judges in this round on their judging portal.')),
                ('presentation_mins',
                 models.IntegerField(blank=True, default=20,
                                     help_text='Duration of startup pitch to judges, in minutes')),
                ('buffer_mins', models.IntegerField(blank=True, default=10,
                                                    help_text='Time between startup pitches, in minutes')),
                ('break_mins', models.IntegerField(blank=True, default=10,
                                                   help_text="Duration of judges' coffee break(s), in minutes")),
                ('num_breaks', models.IntegerField(blank=True, default=1,
                                                   help_text='Number of breaks the judges will be given during a judging panel')),
                ('application_type', models.ForeignKey(blank=True, null=True,
                                                       on_delete=django.db.models.deletion.CASCADE,
                                                       to=swapper.get_model_name('accelerator', 'APPLICATIONTYPE'))),
            ],
            options={
                ...
                'ordering': ['program__program_status', '-program__end_date',
                             '-end_date_time', 'name'],
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'JUDGINGROUND'),
            },
        ),
        migrations.CreateModel(
            name='MemberProfile',
            fields=[
                ...
                ('current_program', models.ForeignKey(blank=True, null=True,
                                                      on_delete=django.db.models.deletion.CASCADE,
                                                      to=swapper.get_model_name('accelerator', 'PROGRAM'))),
                ('interest_categories', models.ManyToManyField(blank=True,
                                                               to=swapper.get_model_name('accelerator', 'INTERESTCATEGORY'))),
                ('program_families', models.ManyToManyField(blank=True,
                                                            help_text='Which of our Program Families would you like to be involved with?',
                                                            related_name='interested_memberprofile',
                                                            to=swapper.get_model_name('accelerator', 'PROGRAMFAMILY'))),
                ('recommendation_tags', models.ManyToManyField(blank=True,
                                                               to=swapper.get_model_name('accelerator', 'RECOMMENDATIONTAG'))),
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'MEMBERPROFILE'),
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'MENTORINGSPECIALTIES'),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('finalist', models.ForeignKey(blank=True, null=True,
                                               on_delete=django.db.models.deletion.CASCADE,
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'MENTORPROGRAMOFFICEHOUR'),
            },
        ),
        migrations.CreateModel(
            name='Newsletter',
            fields=[
                ...
                ('from_addr',
                 models.CharField(blank=True, max_length=255, null=True)),
                ('cc_addrs', models.CharField(blank=True,
                                              help_text='Zero or more email addresses to CC; separate with commas',
                                              max_length=500, null=True)),
                ('date_mailed',
                 models.DateTimeField(blank=True, editable=False, null=True)),
                ('judging_round', models.ForeignKey(blank=True, null=True,
                                                    on_delete=django.db.models.deletion.CASCADE,
                                                    to=swapper.get_model_name('accelerator', 'JUDGINGROUND'))),
                ('program',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to=swapper.get_model_name('accelerator', 'PROGRAM'))),
            ],
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'NEWSLETTER'),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('newsletter',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to=swapper.get_model_name('accelerator', 'NEWSLETTER'))),
                ('recipient',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to=settings.AUTH_USER_MODEL)),
            ],
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'NEWSLETTERRECEIPT'),
            },
        ),
        migrations.CreateModel(
            name='Observer',
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'OBSERVER'),
            },
        ),
        migrations.CreateModel(
            name='Panel',
            fields=[
                ...
                ('status', models.CharField(
                    choices=[('NOT STARTED', 'NOT STARTED'),
                             ('PREVIEW', 'PREVIEW'), ('ACTIVE', 'ACTIVE'),
                             ('COMPLETED', 'COMPLETED')],
                    default='NOT STARTED', max_length=30)),
                ('applications', models.ManyToManyField(related_name='panels',
                                                        through=swapper.get_model_name('accelerator', 'ApplicationPanelAssignment'),
                                                        to=swapper.get_model_name('accelerator', 'APPLICATION'))),
                ('judges', models.ManyToManyField(related_name='panels',
                                                  through=swapper.get_model_name('accelerator', 'JudgePanelAssignment'),
                                                  to=settings.AUTH_USER_MODEL)),
            ],
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'PANEL'),
            },
        ),
        migrations.CreateModel(
            name='PanelLocation',
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'PANELLOCATION'),
            },
        ),
        migrations.CreateModel(
            name='PanelTime',
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'PANELTIME'),
            },
        ),
        migrations.CreateModel(
            name='PanelType',
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('panel_type',
                 models.CharField(max_length=225, primary_key=True,
                                  serialize=False)),
                ('description', models.CharField(max_length=225)),
                ('judging_round', models.ForeignKey(blank=True, null=True,
                                                    on_delete=django.db.models.deletion.CASCADE,
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'PANELTYPE'),
            },
        ),
        migrations.CreateModel(
            name='Partner',
            fields=[
                ...
                ('description', models.TextField(blank=True,
                                                 help_text='This is the generic description of the Partner, shared across all Programs.',
                                                 max_length=1000)),
                ('partner_logo', sorl.thumbnail.fields.ImageField(blank=True,
                                                                  upload_to='startup_pics',
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'PARTNER'),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('partner',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to=swapper.get_model_name('accelerator', 'PARTNER'))),
                ('team_member',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to=settings.AUTH_USER_MODEL)),
            ],
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'PARTNERTEAMMEMBER'),
            },
        ),
        migrations.CreateModel(
            name='PayPalRefund',
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'PAYPALREFUND'),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regular_application_fee',
                 models.DecimalField(decimal_places=2, default=Decimal('0.00'),
                                     max_digits=7)),
                ('cycle', models.ForeignKey(blank=True, null=True,
                                            on_delete=django.db.models.deletion.CASCADE,
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'PROGRAMOVERRIDE'),
            },
        ),
        migrations.CreateModel(
            name='ProgramPartner',
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('description', models.TextField(blank=True,
                                                 help_text='This is the description of the Partner SPECIFICALLY IN THE CONTEXT OF THE PROGRAM. (Distinct from the generic description of the Partner.) For example, description of In-Kind sponsorship deals specific to a Program would go here.',
                                                 max_length=2000)),
                ('partner',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to=swapper.get_model_name('accelerator', 'PARTNER'))),
            ...
            options={
                ...
                'ordering': ['program__name', 'partner_type__sort_order',
                             'partner'],
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'PROGRAMPARTNER'),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('badge_image', sorl.thumbnail.fields.ImageField(blank=True,
                                                                 upload_to='badge_images')),
                ('badge_display', models.CharField(choices=[('NONE', 'None'), (
                'PARTNER_LIST', 'Only on partner list'), ('PARTNER_PROFILE',
                                                          'Only on partner profile'),
                                                            (
                                                            'PARTNER_LIST_AND_PROFILE',
                                                            'Partner list and profile')],
                                                   default='NONE',
                                                   max_length=30)),
                ('program',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'PROGRAMPARTNERTYPE'),
            },
        ),
        migrations.CreateModel(
            name='ProgramRole',
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'PROGRAMROLE'),
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'PROGRAMROLEGRANT'),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attribute_type', models.CharField(
                    choices=[('django.forms.CharField', 'Text Line'),
                    ...
                    max_length=63, verbose_name='Type')),
                ('attribute_label', models.CharField(
                    help_text='Provide a human-readable label for this attribute.  It must be unique for the selected Program',
                    max_length=127, verbose_name='Label')),
                ('attribute_description', models.CharField(blank=True,
                                                           help_text='Provide "help text" for this attribute',
                                                           max_length=255,
                                                           verbose_name='Description')),
                ('admin_viewable', models.BooleanField(default=False,
                                                       help_text='Can Startup Administrators view this attribute for their own Startups?')),
                ('non_admin_viewable', models.BooleanField(default=False,
                                                           help_text='Can Non-Startup Administrators view this attribute for their own Startups?')),
                ('staff_viewable', models.BooleanField(default=False,
                                                       help_text='Can MC Staff view this attribute?')),
                ('finalist_viewable', models.BooleanField(default=False,
                                                          help_text='Can Other Finalists view this attribute?')),
                ('mentor_viewable', models.BooleanField(default=False,
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'PROGRAMSTARTUPATTRIBUTE'),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('startup_list_include', models.BooleanField(default=False,
                                                             help_text='Include this startup status as a tab in the public startup list')),
                ('startup_list_tab_title',
                 models.CharField(max_length=50, null=True)),
                ('startup_list_tab_description', models.TextField(blank=True,
                                                                  help_text='You may use HTML, including links',
                                                                  max_length=1000)),
                ('startup_list_tab_id',
                 models.CharField(help_text='The slug used in the public URL',
                ...
                ('badge_image', sorl.thumbnail.fields.ImageField(blank=True,
                                                                 upload_to='badge_images')),
                ('badge_display', models.CharField(choices=[('NONE', 'None'), (
                'STARTUP_LIST', 'Only on startup list'), ('STARTUP_PROFILE',
                                                          'Only on startup profile'),
                                                            (
                                                            'STARTUP_LIST_AND_PROFILE',
                                                            'Startup list and profile')],
                                                   default='NONE',
                                                   max_length=30)),
                ('status_group', models.CharField(blank=True,
                                                  help_text='Only one status is shown from the same status group; which one is determined by sort order',
                                                  max_length=50, null=True)),
                ('sort_order',
                 models.IntegerField(blank=True, help_text='Order',
                                     null=True)),
                ('program',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to=swapper.get_model_name('accelerator', 'PROGRAM'))),
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'PROGRAMSTARTUPSTATUS'),
            },
        ),
        migrations.CreateModel(
            name='RefundCode',
            fields=[
                ...
                ('maximum_uses',
                 models.PositiveIntegerField(blank=True, default=1,
                                             help_text='Indicate the maximum number of valid redemptions for this code. A null value is interpreted as unlimited.',
                                             null=True,
                                             verbose_name='Maximum Uses')),
                ('notes', models.CharField(blank=True, max_length=300)),
                ('internal', models.BooleanField(default=False,
                                                 help_text='If set then this code is intended for internal use (e.g, Early Bird discount) and cannot be entered directly by users.')),
                ('issued_to', models.ForeignKey(blank=True, null=True,
                                                on_delete=django.db.models.deletion.CASCADE,
                                                to=swapper.get_model_name('accelerator', 'PARTNER'))),
                ('programs', models.ManyToManyField(blank=True,
                                                    help_text='Which programs is this refund code valid for? If no programs are given, then this code can be applied to any program.',
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'REFUNDCODE'),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at',
                 models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('refund_status', models.CharField(blank=True, choices=[
                    ('not_eligible', 'Not Eligible For Refund'),
                    ('required', 'Refund Due'), ('instant', 'Refund Issued'),
                    ('delayed', 'Refund Pending'),
                    ('failed', 'Refund Failed')], max_length=32)),
                ...
                ('refund_code',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   ...
                                   to=swapper.get_model_name('accelerator', 'REFUNDCODE'))),
                ('startup', models.ForeignKey(blank=True, null=True,
                                              on_delete=django.db.models.deletion.CASCADE,
                                              to=swapper.get_model_name('accelerator', 'STARTUP'))),
            ],
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'REFUNDCODEREDEMPTION'),
            },
        ),
        migrations.CreateModel(
            name='Scenario',
            fields=[
                ...
                ('max_panels_per_judge',
                 models.IntegerField(blank=True, null=True)),
                ('min_panels_per_judge',
                 models.IntegerField(blank=True, default=0)),
                ('sequence_number', models.PositiveIntegerField(blank=True,
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'SCENARIO'),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scenario',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to=swapper.get_model_name('accelerator', 'SCENARIO'))),
            ],
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'SCENARIOAPPLICATION'),
            },
        ),
        migrations.CreateModel(
            name='ScenarioJudge',
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'SCENARIOJUDGE'),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('constraint_type', models.CharField(
                    choices=[('max', 'Maximum number of'),
                             ('min', 'Minimum number of')], max_length=16)),
                ('entity_type', models.CharField(choices=[('JUDGE', 'judge'), (
                'APPLICATION', 'application')], max_length=16)),
                ('entity_set', models.CharField(
                    choices=[('all', 'Judges Overall'),
                             ('is_female', 'Judges that are Female'),
                             ('is_lawyer', 'Judges that are Lawyers'),
                             ('is_executive', 'Judges that are Executives'),
                             ('is_investor', 'Judges that are Investors'),
                             ('group_1', 'Judges in Group 1'),
                             ('group_2', 'Judges in Group 2'),
                             ('group_3', 'Judges in Group 3'),
                             ('group_4', 'Judges in Group 4'),
                             ('group_5', 'Judges in Group 5'), (
                             'most_reliable',
                             'Judges that are the most reliable'), (
                             'kinda_reliable',
                             'Judges that are kinda reliable'),
                             ('not_reliable', 'Judges that are not reliable'),
                             ('is_unassigned',
                              'Judges that were not assigned this round'), (
                             'expert_in_industry',
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'SCENARIOPREFERENCE'),
            },
        ),
        migrations.CreateModel(
            name='Section',
            fields=[
                ...
                ('include_for', models.CharField(
                    ...
                    default='EVERYONE', max_length=32)),
                ('sequence', models.PositiveIntegerField(
                    help_text='specify the order of this section in the newsletter')),
                ('interest_categories', models.ManyToManyField(blank=True,
                                                               to=swapper.get_model_name('accelerator', 'INTERESTCATEGORY'))),
                ('newsletter',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'SECTION'),
            },
        ),
        migrations.CreateModel(
            name='Site',
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'SITE'),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to=swapper.get_model_name('accelerator', 'SITE'))),
            ],
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'SITEPROGRAMAUTHORIZATION'),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attribute',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to=swapper.get_model_name('accelerator', 'PROGRAMSTARTUPATTRIBUTE'))),
                ('startup',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to=swapper.get_model_name('accelerator', 'STARTUP'))),
            ],
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'STARTUPATTRIBUTE'),
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'STARTUPCYCLEINTEREST'),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at',
                 models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('status', models.CharField(choices=[('Desired', 'Desired'), (
                'In Discussions With', 'In Discussions With'), ('Confirmed',
                                                                'Confirmed')],
                                            default='Desired', max_length=32)),
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'STARTUPMENTORRELATIONSHIP'),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at',
                 models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('other_mentors', models.TextField(blank=True,
                ...
                ('notes', models.TextField(blank=True,
                                           help_text='Submit the 3 goals you plan to work on with your Mentors during the Accelerator Program and report them here.',
                                           null=True,
                ...
                ('mentors', models.ManyToManyField(
                    ...
                    through=swapper.get_model_name('accelerator', 'StartupMentorRelationship'),
                    to=settings.AUTH_USER_MODEL,
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'STARTUPMENTORTRACKINGRECORD'),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('program_override',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to=swapper.get_model_name('accelerator', 'PROGRAMOVERRIDE'))),
                ('startup',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to=swapper.get_model_name('accelerator', 'STARTUP'))),
            ],
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'STARTUPOVERRIDEGRANT'),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interest_level', models.CharField(blank=True, choices=[
                    ('g', 'Definitely will participate'),
                    ('w', 'Will participate'),
                    ('p', 'Likely will participate'),
                    ('n', 'Might not participate'),
                    ('l', "Likely won't participate")], max_length=64,
                                                    null=True)),
                ('program',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to=swapper.get_model_name('accelerator', 'PROGRAM'))),
                ('startup',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to=swapper.get_model_name('accelerator', 'STARTUP'))),
                ('startup_cycle_interest',
                 models.ForeignKey(blank=True, null=True,
                                   on_delete=django.db.models.deletion.CASCADE,
                                   to=swapper.get_model_name('accelerator', 'STARTUPCYCLEINTEREST'))),
            ],
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'STARTUPPROGRAMINTEREST'),
            },
        ),
        migrations.CreateModel(
            name='StartupRole',
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'STARTUPROLE'),
            },
        ),
        migrations.CreateModel(
            name='StartupStatus',
            fields=[
                ...
                ('program_startup_status',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to=swapper.get_model_name('accelerator', 'PROGRAMSTARTUPSTATUS'))),
                ('startup',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to=swapper.get_model_name('accelerator', 'STARTUP'))),
            ],
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'STARTUPSTATUS'),
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'STARTUPTEAMMEMBER'),
            },
        ),
        migrations.CreateModel(
            name='UserLabel',
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'USERLABEL'),
            },
        ),
        migrations.CreateModel(
            name='UserRole',
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.get_model_name('accelerator', 'USERROLE'),
            },
        ),
        migrations.CreateModel(
            name='PayPalPayment',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to=swapper.get_model_name('accelerator', 'STARTUPMENTORTRACKINGRECORD')),
        ),
        migrations.AddField(
            model_name='startupcycleinterest',
            name='interested_programs',
            field=models.ManyToManyField(
                through=swapper.get_model_name('accelerator', 'StartupProgramInterest'),
                to=swapper.get_model_name('accelerator', 'PROGRAM')),
        ),
        migrations.AddField(
            model_name='startupcycleinterest',
        ...
        migrations.AddField(
            model_name='scenario',
            name='applications',
            field=models.ManyToManyField(related_name='scenarios',
                                         through=swapper.get_model_name('accelerator', 'ScenarioApplication'),
                                         to=swapper.get_model_name('accelerator', 'APPLICATION')),
        ),
        migrations.AddField(
            model_name='scenario',
            name='judges',
            field=models.ManyToManyField(related_name='scenarios',
                                         through=swapper.get_model_name('accelerator', 'ScenarioJudge'),
                                         to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='scenario',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True,
                                    on_delete=django.db.models.deletion.CASCADE,
                                    to=swapper.get_model_name('accelerator', 'STARTUPROLE')),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True,
                                    on_delete=django.db.models.deletion.CASCADE,
                                    to=swapper.get_model_name('accelerator', 'USERROLE')),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to=swapper.get_model_name('accelerator', 'PROGRAMPARTNERTYPE')),
        ),
        migrations.AddField(
            model_name='programpartner',
            name='program',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True,
                                    on_delete=django.db.models.deletion.CASCADE,
                                    to=swapper.get_model_name('accelerator', 'PANELLOCATION')),
        ),
        migrations.AddField(
            model_name='panel',
            name='panel_time',
            field=models.ForeignKey(blank=True, null=True,
                                    on_delete=django.db.models.deletion.CASCADE,
                                    to=swapper.get_model_name('accelerator', 'PANELTIME')),
        ),
        migrations.AddField(
            model_name='panel',
            name='panel_type',
            field=models.ForeignKey(blank=True, null=True,
                                    on_delete=django.db.models.deletion.CASCADE,
                                    to=swapper.get_model_name('accelerator', 'PANELTYPE')),
        ),
        migrations.AddField(
            model_name='observer',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True,
                                    help_text='Optional: merge the display of this feedback with another round',
                                    null=True,
                                    on_delete=django.db.models.deletion.CASCADE,
                                    to=swapper.get_model_name('accelerator', 'JUDGINGROUND')),
        ),
        ...
        migrations.AddField(
            model_name='judginground',
            name='startup_label',
            field=models.ForeignKey(blank=True, help_text='Label for Startups',
                                    null=True,
                                    on_delete=django.db.models.deletion.CASCADE,
                                    to=swapper.get_model_name('accelerator', 'STARTUPLABEL')),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to=swapper.get_model_name('accelerator', 'PANEL')),
        ),
        migrations.AddField(
            model_name='judgepanelassignment',
            name='scenario',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to=swapper.get_model_name('accelerator', 'JUDGINGFORMELEMENT')),
        ),
        migrations.AddField(
            model_name='judgefeedbackcomponent',
            name='judge_feedback',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to=swapper.get_model_name('accelerator', 'JUDGEAPPLICATIONFEEDBACK')),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to=swapper.get_model_name('accelerator', 'JUDGEROUNDCOMMITMENT')),
        ),
        migrations.AddField(
            model_name='judgeavailability',
            name='panel_location',
        ...
        migrations.AddField(
            model_name='judgeapplicationfeedback',
            name='viewers',
            field=models.ManyToManyField(related_name='viewed_feedback',
                                         to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to=swapper.get_model_name('accelerator', 'EXPERTCATEGORY'),
                verbose_name='I primarily consider myself a'),
        ),
        migrations.AddField(
            model_name='expertprofile',
            name='functional_expertise',
            field=models.ManyToManyField(blank=True, related_name='experts',
                                         to=settings.MPTT_SWAPPABLE_FUNCTIONALEXPERTISE_MODEL,
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True,
                                         ...
                                         related_name='experts',
                                         to=swapper.get_model_name('accelerator', 'MENTORINGSPECIALTIES'),
        ...
        migrations.AlterUniqueTogether(
            name='judgeavailability',
            unique_together=set([('commitment', 'panel_location', 'panel_time',
                                  'panel_type')]),
        ),
        migrations.AlterUniqueTogether(
            name='judgeapplicationfeedback',
