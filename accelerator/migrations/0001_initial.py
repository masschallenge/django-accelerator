    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional_industries', models.ManyToManyField(blank=True, db_table='accelerator_startup_related_industry', help_text='You may select up to 5 related industries.', related_name='secondary_startups', to=swapper.get_model_name('accelerator', 'Industry'), verbose_name='Additional Industries')),
                ('currency', models.ForeignKey(blank=True, null=True,
                                               on_delete=django.db.models.deletion.CASCADE, to=swapper.get_model_name('accelerator', 'Currency'))),
                ('organization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='startups', to=swapper.get_model_name('accelerator', 'Organization'))),
                ('primary_industry', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='startups', to=swapper.get_model_name('accelerator', 'Industry'), verbose_name='Primary Industry categorization')),
                ('recommendation_tags', models.ManyToManyField(blank=True,
                                                               to=swapper.get_model_name('accelerator', 'RecommendationTag'))),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='acc_startups', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to=swapper.get_model_name('accelerator', 'Startup')),
        ),
    ]
