# -*- coding: utf-8 -*-
# Generated by Django 1.10.8 on 2019-09-13 18:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name_plural': 'assignments of startup applications'
                                       ' to panel',
            ...
            fields=[
                ...
                ('gender', models.CharField(
                    choices=[('f', 'Female'), ('m', 'Male'),
                             ('p', 'Prefer Not To State'), ('o', 'Other'),
                             ('', 'Unknown')], default='', max_length=1)),
                ('phone',
                 models.CharField(
                     blank=True, max_length=20, validators=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topics', models.TextField(
                    blank=True,
                    help_text='Please provide a list of topics of interest'
                              ' to yo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('judge_interest',
                 models.BooleanField(
                     default=False,
                     help_text='I would like to participate in MassChallenge '
                               'as a Judge',
                     verbose_name='Judge')),
                ...
                ('speaker_topics', models.TextField(
                    blank=True,
                    help_text='Please describe the topic(s) you would be '
                ...
                ('office_hours_topics', models.TextField(
                    blank=True,
                    help_text='Please describe the topic(s) you would be '
                              'available to speak to Finalists about during '
                              'Office Hours',
                ...
                ('referred_by', models.TextField(
                    blank=True,
                    help_text='If someone referred you to MassChallenge,'
                              ' please provide their name (and organization'
                              ' if relevant). Otherwise, please indicate how'
                              ' you learned about the opportunity to '
                              'participate at MassChallenge (helps us '
                              'understand the effectiveness of our outreach '
                              'programs).',
                    max_length=500)),
                ('other_potential_experts', models.TextField(
                    blank=True,
                    help_text="We're always looking for more great experts to"
                              " join the MassChallenge community and program."
                              " We welcome the names and contact info (email)"
                              " of individuals you think could be great "
                              "additions to the program, as well as how you"
                              " think they might want to be involved (Judge,"
                              " Mentor, etc.) Also, please encourage these "
                              "individuals to fill out their own Expert "
                              "Profile.",
                    max_length=500)),
                ('internal_notes', models.TextField(
                    blank=True,
                    help_text='Internal notes only for use by MassChallenge'
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(
                    storage=SecureFileSystemStorage(
                        location='/var/www/cms-files'),
                    upload_to='%Y-%m')),
            ...
            fields=[
                ...
                ('availability_type', models.CharField(
                    choices=[('Available', 'Available'),
                             ...
                             ('Preferred', 'Preferred')], max_length=32)),
            ],
            options={
                'verbose_name_plural': 'Judge availability for specific'
            ...
            fields=[
                ...
                ('panel_sequence_number',
                 models.PositiveIntegerField(
                     blank=True,
                     help_text='Indicate in which order this panel should be'
                               ' completed by this judge',
                     null=True)),
                ('judge',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to=settings.AUTH_USER_MODEL)),
            ...
            fields=[
                ...
                ('application_question',
                 models.ForeignKey(
                     blank=True, null=True,
                     on_delete=django.db.models.deletion.CASCADE,
                     to=settings.ACCELERATOR_APPLICATIONQUESTION_MODEL)),
                ('form_type',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to=settings.ACCELERATOR_JUDGINGFORM_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cycle_based_round', models.BooleanField(
                    default=False,
                    help_text="Include startups from all programs in this "
                              "Program's cycle")),
                ...
                ('round_type',
                 models.CharField(choices=[('Online', 'Online'),
                                           ('In-Person', 'In-Person')],
                                  max_length=10)),
                ('allow_dynamic_allocation', models.BooleanField(
                    default=False,
                    help_text='Check this button to allow judges to get new'
                              ' applications without manual allocation by'
                              ' staff.')),
                ...
                ('recruit_judges', models.CharField(
                    choices=[
                        ...
                        ('ANYONE', 'Recruit any expert'),
                        ('APPROVEDONLY', 'Recruit only approved judges'),
                        ('DISPLAYONLY',
                         'Only display judges prior commitments')],
                    default='NO', max_length=16)),
                ...
                ('capacity_options',
                 models.CharField(
                     ...
                     max_length=255,
                     validators=[
                         accelerator_abstract.utils.validate_capacity_options])
                 ),
                ...
                ('feedback_display',
                 models.CharField(choices=[('disabled', 'Disabled'),
                                           ('enabled', 'Enabled')],
                                  default='disabled',
                                  max_length=10)),
                ('feedback_display_message', models.TextField(
                    blank=True,
                    help_text='You may use HTML, including links (not relevant'
                              ' if merged with another round)')),
                ...
                ('judge_instructions', models.TextField(
                    blank=True,
                    help_text='Instructions to present to judges in this '
                              'round on their judging portal.')),
                ('presentation_mins',
                 models.IntegerField(
                     blank=True, default=20,
                     help_text='Duration of startup pitch to judges, '
                               'in minutes')),
                ('buffer_mins',
                 models.IntegerField(
                ...
                ('break_mins', models.IntegerField(
                    blank=True, default=10,
                    help_text="Duration of judges' coffee break(s), "
                              "in minutes")),
                ('num_breaks', models.IntegerField(
                    blank=True, default=1,
                    help_text='Number of breaks the judges will be given '
                              'during a judging panel')),
                ('collision_detection_mode', models.CharField(
                    choices=[
                        ('scenario',
                         'Check that applications are not added to a '
                         'scenario twice'),
                        ('panel_time',
                         'Check that applications are not added to the same'
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(
                    help_text='Text displayed next to checkbox. Use HTML '
                              'for links.')),
                ('is_enabled_for_experts',
                 models.BooleanField(
                     default=True,
                     help_text='This legal check is for Experts (Judges and'
                               ' Mentors)')),
                ('is_enabled_for_entrepreneurs',
                 models.BooleanField(
                     default=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alias', models.CharField(
                    db_index=True,
                    help_text='Short name to address site tree from templates'
                              '.<br /><b>Note:</b> change with care.',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title',
                 models.CharField(
                     help_text='Site tree item title. Can contain template '
                               'variables E.g.: {{ mytitle }}.',
                     max_length=100, verbose_name='Title')),
                ('hint', models.CharField(
                    blank=True, default='',
                    help_text='Some additional information about this item '
                              'that is used as a hint.',
                    max_length=200,
                    verbose_name='Hint')),
                ('url', models.CharField(
                    db_index=True,
                    help_text='Exact URL or URL pattern (see "Additional '
                              'settings") for this item.',
                    max_length=200, verbose_name='URL')),
                ('urlaspattern',
                 models.BooleanField(
                     db_index=True, default=False,
                     help_text='Whether the given URL should be treated as a '
                               'pattern.<br /><b>Note:</b> Refer to Django '
                               '"URL dispatcher" documentation (e.g. "Naming '
                               'URL patterns" part).',
                ...
                ('alias',
                 sitetree.models.CharFieldNullable(
                     ...
                     help_text='Short name to address site tree item from a '
                               'template.<br /><b>Reserved aliases:</b> '
                               '"trunk", "this-children", "this-siblings", '
                               '"this-ancestor-children", "this-parent-'
                               'siblings".',
                ...
                ('inbreadcrumbs',
                 models.BooleanField(
                     db_index=True, default=True,
                     help_text='Whether to show this item in a breadcrumb'
                               ' path.',
                ...
                ('access_loggedin',
                 models.BooleanField(
                     db_index=True, default=False,
                     help_text='Check it to grant access to this item to '
                ...
                ('access_restricted',
                 models.BooleanField(
                     db_index=True, default=False,
                     help_text='Check it to restrict user access to this item,'
                ...
                ('access_perm_type',
                 models.IntegerField(
                     choices=[(1, 'Any'), (2, 'All')],
                     default=1,
                     help_text='<b>Any</b> &mdash; user should have any of '
                               'chosen permissions. <b>All</b> &mdash; user '
                               'should have all chosen permissions.',
                     verbose_name='Permissions interpretation')),
                ('sort_order', models.IntegerField(
                    db_index=True, default=0,
                    help_text='Item position among other site tree items under'
                              ' the same parent.',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cc_addrs',
                 models.CharField(
                     blank=True,
                     help_text='Zero or more email addresses to CC; separate'
                               ' with commas',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('newsletter',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to=settings.ACCELERATOR_NEWSLETTER_MODEL)),
                ('recipient',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   to=settings.AUTH_USER_MODEL)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applications',
                 models.ManyToManyField(
                     related_name='panels',
                     through='accelerator.ApplicationPanelAssignment',
                     to=settings.ACCELERATOR_APPLICATION_MODEL)),
                ('judges', models.ManyToManyField(
                    related_name='panels',
                    through='accelerator.JudgePanelAssignment',
                    to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(
                    blank=True,
                    help_text='This is the generic description of the Partner,'
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment',
                 models.ForeignKey(
                     on_delete=django.db.models.deletion.CASCADE,
                     to=settings.ACCELERATOR_PAYPALPAYMENT_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alumni_eligible_program', models.BooleanField(
                    default=False,
                    help_text='Finalists will be added to our Global Alumni '
                              'Program upon this program being set to "Ended"')
                ...
                ('approved_judge_message', models.TextField(
                    blank=True,
                    help_text='You may use HTML, including links')),
                ('interested_mentor_message',
                 models.TextField(
                     blank=True,
                     help_text='You may use HTML, including links')),
                (
                    'approved_mentor_message',
                    models.TextField(
                        blank=True,
                        help_text='You may use HTML, including links')),
                ('interested_speaker_message',
                 models.TextField(
                     blank=True,
                     help_text='You may use HTML, including links')),
                ('approved_speaker_message',
                 models.TextField(
                     blank=True,
                     help_text='You may use HTML, including links')),
                ...
                ('many_codes_per_partner', models.BooleanField(
                    default=False,
                    help_text='If true, then a given application may apply '
                              'more than one refund code from the same partner'
                              ' for this program',
                ...
                ('overview_start_date',
                 models.DateTimeField(blank=True, help_text='Time is in UTC',
                                      null=True)),
            ...
            fields=[
                ...
                ('office_hour_bcc', models.EmailField(
                    ...
                    help_text='An email address to bcc whenever office hours '
                              'are created, deleted, or modified in this '
                              'program family',
                    max_length=100,
                    null=True)),
            ...
            fields=[
                ...
                ('description', models.TextField(
                    ...
                    help_text='This is the description of the Partner '
                              ...
                              '(Distinct from the generic description of the '
                              'Partner.) For example, description of In-Kind '
                              'sponsorship deals specific to a Program would '
                              'go here.',
                    max_length=2000)),
                ('partner',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('badge_image', sorl.thumbnail.fields.ImageField(
                    blank=True,
                    upload_to='badge_images')),
                ('badge_display', models.CharField(choices=[
                    ('NONE', 'None'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attribute_type', models.CharField(
                    ...
                    help_text='Select the type of information for'
                              ' this attribute',
                    max_length=63, verbose_name='Type')),
                ('attribute_label', models.CharField(
                    help_text='Provide a human-readable label for this '
                              'attribute.  It must be unique for the selected'
                              ' Program',
                ...
                ('admin_viewable', models.BooleanField(
                    default=False,
                    help_text='Can Startup Administrators view this attribute'
                              ' for their own Startups?')),
                ('non_admin_viewable', models.BooleanField(
                    default=False,
                    help_text='Can Non-Startup Administrators view this '
                              'attribute for their own Startups?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('startup_list_include', models.BooleanField(
                    default=False,
                    help_text='Include this startup status as a tab in the '
                              'public startup list')),
                ('startup_list_tab_title',
                 models.CharField(max_length=50, null=True)),
                ('startup_list_tab_description',
                 models.TextField(
                     blank=True,
                     help_text='You may use HTML, including links',
                     max_length=1000)),
                ...
                ('badge_image', sorl.thumbnail.fields.ImageField(
                    blank=True,
                    upload_to='badge_images')),
                ('badge_display', models.CharField(
                    choices=[('NONE', 'None'),
                ...
                ('status_group', models.CharField(
                    blank=True,
                    help_text='Only one status is shown from the same status '
                              'group; which one is determined by sort order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('maximum_uses',
                 models.PositiveIntegerField(
                     blank=True, default=1,
                     help_text='Indicate the maximum number of valid '
                               'redemptions for this code. A null value is '
                ...
                ('internal', models.BooleanField(
                    default=False,
                    help_text='If set then this code is intended for internal '
                              'use (e.g, Early Bird discount) and cannot be '
                              'entered directly by users.')),
            ...
            fields=[
                ...
                ('refund_code',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   ...
                                   to=settings.ACCELERATOR_REFUNDCODE_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sequence_number', models.PositiveIntegerField(
                    blank=True,
                    help_text='Indicate the order for this scenario within'
                              ' the round',
                    null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('constraint_type',
                 models.CharField(choices=[('max', 'Maximum number of'),
                                           ('min', 'Minimum number of')],
                                  max_length=16)),
                ('entity_type',
                 models.CharField(choices=[('JUDGE', 'judge'),
                ...
                ('entity_set', models.CharField(
                    choices=[
                        ...
                        ('expert_in_industry',
                         "Judges w/ expertise in the startup's primary"
                         " industry"),
                        ('also_knows_industry',
                         "Judges w/ secondary expertise in the startup's"
                         " primary industry"),
                        ('in_program',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sequence',
                 models.PositiveIntegerField(
                     help_text='specify the order of this section in '
                               'the newsletter')),
                ('interest_categories',
                 models.ManyToManyField(
                     blank=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site',
                 models.ForeignKey(
                     on_delete=django.db.models.deletion.CASCADE,
                     to=settings.ACCELERATOR_SITE_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facebook_url', models.URLField(
                    blank=True, max_length=100,
                    verbose_name='Facebook profile URL')),
                ('high_resolution_logo', sorl.thumbnail.fields.ImageField(
                    blank=True, upload_to='startup_pics',
                ...
                ('acknowledgement', models.BooleanField(
                    ...
                    help_text='I understand that my Startup Profile is a '
                              'pre-requisite for applying to any MassChallenge'
                              ' Program')),
                ...
                ('location_national', models.CharField(
                    blank=True, default='',
                    help_text='Please specify the country where your '
                              'main office (headquarters) is located',
                    max_length=100)),
                ...
                ('location_postcode', models.CharField(
                    blank=True,
                    default='',
                    help_text='Please specify the postal code for your '
                              'main office (headquarters). (ZIP code, '
                              'Postcode, codigo postal, etc.)',
                    max_length=100)),
                ...
                ('currency', models.ForeignKey(
                    ...
                    null=True,
                    on_delete=django.db.models.deletion.CASCADE,
                    to=settings.ACCELERATOR_CURRENCY_MODEL)),
                ('organization', models.ForeignKey(
                    blank=True,
                    null=True,
                    on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attribute', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE,
                    to=settings.ACCELERATOR_PROGRAMSTARTUPATTRIBUTE_MODEL)),
                ('startup',
                 models.ForeignKey(
                     on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('other_mentors', models.TextField(
                    blank=True,
                    help_text='Add any mentors you meet with who are not '
                              'listed in the MassChallenge Mentor Directory.'
                              ' Please provide their name, company, and email'
                              ' address below.',
                    null=True,
                    verbose_name='Additional Mentors')),
                ('notes', models.TextField(
                    blank=True,
                    help_text='Submit the three goals you plan to work on with'
                              ' your mentors during the accelerator program.',
                    null=True, verbose_name='Program Goals')),
                ('mentors', models.ManyToManyField(
                    help_text="Select the Mentors you would like to "
                              "work with during the program. Start typing"
                              " a Mentor's name; if they are in the Mentor"
                              " Directory, their name should appear as you"
                              " type. If you don't find the person you are "
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('program_override', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE,
                    to=settings.ACCELERATOR_PROGRAMOVERRIDE_MODEL)),
                ('startup',
                 models.ForeignKey(
                     on_delete=django.db.models.deletion.CASCADE,
                     to=settings.ACCELERATOR_STARTUP_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interest_level', models.CharField(
                    blank=True,
                    choices=[('g', 'Definitely will participate'),
                             ('w', 'Will participate'),
                ...
                ('startup_cycle_interest',
                 models.ForeignKey(
                     ...
                     null=True,
                     on_delete=django.db.models.deletion.CASCADE,
                     to=settings.ACCELERATOR_STARTUPCYCLEINTEREST_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('program_startup_status', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE,
                    to=settings.ACCELERATOR_PROGRAMSTARTUPSTATUS_MODEL)),
                ('startup',
                 models.ForeignKey(
                     on_delete=django.db.models.deletion.CASCADE,
                     to=settings.ACCELERATOR_STARTUP_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_on_public_profile', models.BooleanField(
                    default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('legal_check', models.ForeignKey(
                    ...
                    to=settings.ACCELERATOR_LEGALCHECK_MODEL)),
                ('user', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to=settings.ACCELERATOR_STARTUPMENTORTRACKINGRECORD_MODEL),
        ),
        migrations.AddField(
            model_name='startupcycleinterest',
            name='interested_programs',
            field=models.ManyToManyField(
                through='accelerator.StartupProgramInterest',
                to=settings.ACCELERATOR_PROGRAM_MODEL),
        ),
        migrations.AddField(
            model_name='startupcycleinterest',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through='accelerator.ScenarioApplication',
                to=settings.ACCELERATOR_APPLICATION_MODEL),
        ),
        migrations.AddField(
            model_name='scenario',
            ...
            field=models.ManyToManyField(
                related_name='scenarios',
                through='accelerator.ScenarioJudge',
                to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='scenario',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                to=settings.ACCELERATOR_STARTUPROLE_MODEL),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to=settings.ACCELERATOR_USERLABEL_MODEL),
        ),
        migrations.AddField(
            model_name='programrole',
            name='user_role',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to=settings.ACCELERATOR_PROGRAMPARTNERTYPE_MODEL),
        ),
        migrations.AddField(
            model_name='programpartner',
            name='program',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                to=settings.ACCELERATOR_NAMEDGROUP_MODEL),
        ),
        migrations.AddField(
            model_name='program',
            name='program_family',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                to=settings.ACCELERATOR_PANELLOCATION_MODEL),
        ),
        migrations.AddField(
            model_name='panel',
            name='panel_time',
            field=models.ForeignKey(
                blank=True, null=True,
                on_delete=django.db.models.deletion.CASCADE,
                to=settings.ACCELERATOR_PANELTIME_MODEL),
        ),
        migrations.AddField(
            model_name='panel',
            name='panel_type',
            field=models.ForeignKey(
                ...
                to=settings.ACCELERATOR_PANELTYPE_MODEL),
        ),
        migrations.AddField(
            model_name='observer',
        ...
        migrations.AddField(
            ...
            name='sub_nav',
            field=models.ForeignKey(
                help_text='This is the sub navigation tree that'
        ...
        migrations.AddField(
            ...
            name='sub_nav_item',
            field=models.ForeignKey(
                help_text='This is the sub navigation item'
        ...
        migrations.AddField(
            ...
            name='program',
            field=models.ManyToManyField(
                blank=True, to=settings.ACCELERATOR_PROGRAM_MODEL),
        ),
        migrations.AddField(
            model_name='navtreeitem',
            name='program_family',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True,
                help_text='Which of our Program Families '
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True,
                help_text='Optional: merge the display of this feedback '
                          'with another round',
                null=True, on_delete=django.db.models.deletion.CASCADE,
                to=settings.ACCELERATOR_JUDGINGROUND_MODEL),
        ),
        ...
        migrations.AddField(
            ...
            name='startup_label',
            field=models.ForeignKey(
                blank=True, help_text='Label for Startups', null=True,
                on_delete=django.db.models.deletion.CASCADE,
                to=settings.ACCELERATOR_STARTUPLABEL_MODEL),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to=settings.ACCELERATOR_PANEL_MODEL),
        ),
        migrations.AddField(
            model_name='judgepanelassignment',
            name='scenario',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to=settings.ACCELERATOR_JUDGINGFORMELEMENT_MODEL),
        ),
        migrations.AddField(
            model_name='judgefeedbackcomponent',
            name='judge_feedback',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to=settings.ACCELERATOR_JUDGEAPPLICATIONFEEDBACK_MODEL),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to=settings.ACCELERATOR_JUDGEROUNDCOMMITMENT_MODEL),
        ),
        migrations.AddField(
            model_name='judgeavailability',
            name='panel_location',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                help_text='You may select up to 5 related industries. '
                          'To select multiple industries, please press '
                          'and hold Control (CTRL) on PCs or Command '
                          '(&#8984;) on Macs.',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True,
                help_text='Which of our Program Families would'
                          ' you like to be involved with?',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to=settings.ACCELERATOR_EXPERTINTERESTTYPE_MODEL),
        ),
        migrations.AddField(
            model_name='expertinterest',
            name='program_family',
        ...
        migrations.AddField(
            ...
            name='interest_categories',
            field=models.ManyToManyField(
                blank=True, to=settings.ACCELERATOR_INTERESTCATEGORY_MODEL),
        ),
        migrations.AddField(
            model_name='entrepreneurprofile',
            name='program_families',
            field=models.ManyToManyField(
                blank=True,
                help_text='Which of our Program Families would you '
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                to=settings.ACCELERATOR_QUESTION_MODEL),
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(
            name='judgeavailability',
            unique_together=set([('commitment',
                                  'panel_location',
                                  'panel_time',
                                  'panel_type')]),
        ),
