...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ManyToManyField(blank=True, help_text='Select as many options as you feel best represent your identity. Please press and hold Control (CTRL) on PCs or Command (&#8984;) on Macs to select multiple options', to=settings.ACCELERATOR_ETHNORACIALIDENTITY_MODEL),
        ),
        migrations.AlterField(
            model_name='entrepreneurprofile',
            name='gender_identity',
            field=models.ManyToManyField(blank=True, help_text='Select as many options as you feel best represent your identity. Please press and hold Control (CTRL) on PCs or Command (&#8984;) on Macs to select multiple options', to=settings.ACCELERATOR_GENDERCHOICES_MODEL),
        ),
        migrations.AlterField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('f', 'Female'), ('m', 'Male'), ('p', 'Prefer Not To State'), ('o', 'Other'), ('', 'Unknown')], default='', max_length=1, null=True)),
                ...
                ('ethno_racial_identification', models.ManyToManyField(blank=True, help_text='Select as many options as you feel best represent your identity. Please press and hold Control (CTRL) on PCs or Command (&#8984;) on Macs to select multiple options', to=settings.ACCELERATOR_ETHNORACIALIDENTITY_MODEL)),
                ('gender_identity', models.ManyToManyField(blank=True, help_text='Select as many options as you feel best represent your identity. Please press and hold Control (CTRL) on PCs or Command (&#8984;) on Macs to select multiple options', to=settings.ACCELERATOR_GENDERCHOICES_MODEL)),
                ('interest_categories', models.ManyToManyField(blank=True, to=settings.ACCELERATOR_INTERESTCATEGORY_MODEL)),
                ('program_families', models.ManyToManyField(blank=True, help_text='Which of our Program Families would you like to be involved with?', related_name='interested_coreprofile', to=settings.ACCELERATOR_PROGRAMFAMILY_MODEL)),
