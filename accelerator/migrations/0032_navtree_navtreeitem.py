    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.swappable_setting('accelerator', 'NavTree'),
            },
        ),
        migrations.CreateModel(
            name='NavTreeItem',
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, help_text='Parent site tree item.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='navtreeitem_parent', to=swapper.get_model_name('accelerator', 'NavTreeItem'), verbose_name='Parent')),
                ('tree', models.ForeignKey(help_text='Site tree this item belongs to.', on_delete=django.db.models.deletion.CASCADE, related_name='navtreeitem_tree', to=swapper.get_model_name('accelerator', 'NavTree'), verbose_name='Site Tree')),
            ],
            options={
                ...
                'abstract': False,
                'managed': True,
                'swappable': swapper.swappable_setting('accelerator', 'NavTreeItem'),
            },
        ),
    ]
