...
# accelerator.migrations.0008_migrate_old_location_data_to_new_location_field
# accelerator.migrations.0012_delete_unused_user_roles
# accelerator.migrations.0019_add_deferred_user_role
# accelerator.migrations.0029_add_gender_choices_data
# accelerator.migrations.0032_add_ethno_racial_identity_data
# accelerator.migrations.0033_migrate_gender_data

class Migration(migrations.Migration):

    replaces = [('accelerator', '0001_initial'), ('accelerator', '0002_added_a_unique_constraint_to_application_answers'), ('accelerator', '0003_add_street_address_to_location'), ('accelerator', '0005_make_location_nullable'), ('accelerator', '0006_remove_userrole_url_slug'), ('accelerator', '0007_remove_program_family_address_and_timezone'), ('accelerator', '0008_migrate_old_location_data_to_new_location_field'), ('accelerator', '0009_remove_choices_from_old_location_field'), ('accelerator', '0010_make_old_location_field_nullable'), ('accelerator', '0011_add_judge_and_expert_type'), ('accelerator', '0012_delete_unused_user_roles'), ('accelerator', '0013_remove_mentorprogramofficehour_old_location'), ('accelerator', '0014_expert_profile_expert_category_alter_verbose_name'), ('accelerator', '0015_past_due_migrations'), ('accelerator', '0016_make_user_role_name_unique'), ('accelerator', '0017_add_required_name'), ('accelerator', '0018_make_location_nonrequired'), ('accelerator', '0019_add_deferred_user_role'), ('accelerator', '0020_auto_20200430_0850'), ('accelerator', '0021_add_nullable_startup_and_program_fields'), ('accelerator', '0022_add_meeting_info_on_office_hour_model'), ('accelerator', '023_alter_topics_field_office_hours'), ('accelerator', '0024_program_show_all_masschallenge_events'), ('accelerator', '0025_add_user_type_to_nav_tree_item'), ('accelerator', '0026_remove_character_limit_to_application_answer'), ('accelerator', '0027_set_swappable_to_none'), ('accelerator', '0027_add_birth_year_to_core_profile'), ('accelerator', '0028_add_gender_choices_object'), ('accelerator', '0029_add_gender_choices_data'), ('accelerator', '0030_add_gender_fields'), ('accelerator', '0031_add_ethno_racial_identity_model'), ('accelerator', '0032_add_ethno_racial_identity_data'), ('accelerator', '0033_migrate_gender_data')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('panel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_PANEL_MODEL)),
                ('scenario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='application_assignments', to=settings.ACCELERATOR_SCENARIO_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('panel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_PANEL_MODEL)),
                ('scenario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='judge_assignments', to=settings.ACCELERATOR_SCENARIO_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('startup_mentor_tracking', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_STARTUPMENTORTRACKINGRECORD_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applications', models.ManyToManyField(related_name='scenarios', through='accelerator.ScenarioApplication', to=settings.ACCELERATOR_APPLICATION_MODEL)),
                ('judges', models.ManyToManyField(related_name='scenarios', through='accelerator.ScenarioJudge', to=settings.AUTH_USER_MODEL)),
                ('judging_round', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_JUDGINGROUND_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('program', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_PROGRAM_MODEL)),
                ('startup_role', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_STARTUPROLE_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('program', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_PROGRAM_MODEL)),
                ('user_label', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dont_use_commit_fail', to=settings.ACCELERATOR_USERLABEL_MODEL)),
                ('user_role', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_USERROLE_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('partner_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_PROGRAMPARTNERTYPE_MODEL)),
                ('program', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_PROGRAM_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_PANELLOCATION_MODEL)),
                ('panel_time', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_PANELTIME_MODEL)),
                ('panel_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_PANELTYPE_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('newsletter_cc_roles', models.ManyToManyField(blank=True, to=settings.ACCELERATOR_PROGRAMROLE_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('node', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fluent_pages.UrlNode')),
                ('sub_nav', models.ForeignKey(help_text='This is the sub navigation tree that this page is tied to', on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_NAVTREE_MODEL)),
                ('sub_nav_item', models.ForeignKey(help_text='This is the sub navigation item that this page is tied to', null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_NAVTREEITEM_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('node', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fluent_pages.UrlNode')),
                ('published_for', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_PROGRAMROLE_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('judging_round', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_JUDGINGROUND_MODEL)),
                ('program', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_PROGRAM_MODEL)),
                ('recipient_roles', models.ManyToManyField(blank=True, to=settings.ACCELERATOR_PROGRAMROLE_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('newsletter_sender', models.BooleanField(default=False)),
                ('current_program', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_PROGRAM_MODEL)),
                ('interest_categories', models.ManyToManyField(blank=True, to=settings.ACCELERATOR_INTERESTCATEGORY_MODEL)),
                ('program_families', models.ManyToManyField(blank=True, help_text='Which of our Program Families would you like to be involved with?', related_name='interested_memberprofile', to=settings.ACCELERATOR_PROGRAMFAMILY_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional_industries', models.ManyToManyField(db_table='accelerator_expert_related_industry', help_text='You may select up to 5 related industries. To select multiple industries, please press and hold Control (CTRL) on PCs or Command (&#8984;) on Macs.', related_name='secondary_experts', to=settings.MPTT_SWAPPABLE_INDUSTRY_MODEL, verbose_name='Additional Industries')),
                ('current_program', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_PROGRAM_MODEL)),
                ('expert_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='experts', to=settings.ACCELERATOR_EXPERTCATEGORY_MODEL, verbose_name='I primarily consider myself a')),
                ('functional_expertise', models.ManyToManyField(blank=True, related_name='experts', to=settings.MPTT_SWAPPABLE_FUNCTIONALEXPERTISE_MODEL, verbose_name='Functional Expertise')),
                ('home_program_family', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_PROGRAMFAMILY_MODEL, verbose_name='Home Program Family')),
                ('interest_categories', models.ManyToManyField(blank=True, to=settings.ACCELERATOR_INTERESTCATEGORY_MODEL)),
                ('mentoring_specialties', models.ManyToManyField(blank=True, db_table='accelerator_expert_related_mentoringspecialty', related_name='experts', to=settings.ACCELERATOR_MENTORINGSPECIALTIES_MODEL, verbose_name='Mentoring Specialties')),
                ('primary_industry', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='experts', to=settings.MPTT_SWAPPABLE_INDUSTRY_MODEL, verbose_name='Primary Industry')),
                ('program_families', models.ManyToManyField(blank=True, help_text='Which of our Program Families would you like to be involved with?', related_name='interested_expertprofile', to=settings.ACCELERATOR_PROGRAMFAMILY_MODEL)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interest_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='interested_experts', to=settings.ACCELERATOR_EXPERTINTERESTTYPE_MODEL)),
                ('program_family', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='interested_experts', to=settings.ACCELERATOR_PROGRAMFAMILY_MODEL)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='expert_interests', to=settings.AUTH_USER_MODEL, validators=[accelerator_abstract.models.base_expert_interest.is_expert_validator])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_program', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_PROGRAM_MODEL)),
                ('interest_categories', models.ManyToManyField(blank=True, to=settings.ACCELERATOR_INTERESTCATEGORY_MODEL)),
                ('program_families', models.ManyToManyField(blank=True, help_text='Which of our Program Families would you like to be involved with?', related_name='interested_entrepreneurprofile', to=settings.ACCELERATOR_PROGRAMFAMILY_MODEL)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cycle', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_PROGRAMCYCLE_MODEL)),
                ('program', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_PROGRAM_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=50)),
                ('description', models.CharField(blank=True, max_length=500)),
                ('submission_label', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_STARTUPLABEL_MODEL)),
            ],
            options={
                'abstract': False,
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choice_options', models.CharField(blank=True, max_length=4000)),
                ('choice_layout', models.CharField(blank=True, choices=[('horizontal', 'Horizontal'), ('vertical', 'Vertical'), ('dropdown', 'Dropdown')], max_length=64)),
                ('application_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_APPLICATIONTYPE_MODEL)),
                ('program', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_PROGRAM_MODEL)),
                ('question', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_QUESTION_MODEL)),
            ],
            options={
                'abstract': False,
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_APPLICATIONTYPE_MODEL)),
                ('cycle', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='applications', to=settings.ACCELERATOR_PROGRAMCYCLE_MODEL)),
                ('startup', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_STARTUP_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('cycle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_PROGRAMCYCLE_MODEL)),
                ('interested_programs', models.ManyToManyField(through='accelerator.StartupProgramInterest', to=settings.ACCELERATOR_PROGRAM_MODEL)),
                ('startup', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_STARTUP_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('startup', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_STARTUP_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('program', models.ManyToManyField(blank=True, to=settings.ACCELERATOR_PROGRAM_MODEL)),
                ('program_family', models.ManyToManyField(blank=True, to=settings.ACCELERATOR_PROGRAMFAMILY_MODEL)),
                ('tree', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_NAVTREE_MODEL)),
                ('user_role', models.ManyToManyField(blank=True, to=settings.ACCELERATOR_USERROLE_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_APPLICATIONTYPE_MODEL)),
                ('confirmed_judge_label', models.ForeignKey(blank=True, help_text='Label for Confirmed Judges', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='rounds_confirmed_for', to=settings.ACCELERATOR_USERLABEL_MODEL)),
                ('desired_judge_label', models.ForeignKey(blank=True, help_text='Label for Desired Judges', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='rounds_desired_for', to=settings.ACCELERATOR_USERLABEL_MODEL)),
                ('feedback_merge_with', models.ForeignKey(blank=True, help_text='Optional: merge the display of this feedback with another round', null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_JUDGINGROUND_MODEL)),
                ('judging_form', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_JUDGINGFORM_MODEL)),
                ('program', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_PROGRAM_MODEL)),
                ('startup_label', models.ForeignKey(blank=True, help_text='Label for Startups', null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_STARTUPLABEL_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feedback_element', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_JUDGINGFORMELEMENT_MODEL)),
                ('judge_feedback', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_JUDGEAPPLICATIONFEEDBACK_MODEL)),
            ],
            options={
                ...
                'index_together': {('id', 'judge_feedback', 'feedback_element')},
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commitment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_JUDGEROUNDCOMMITMENT_MODEL)),
                ('panel_location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_PANELLOCATION_MODEL)),
                ('panel_time', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_PANELTIME_MODEL)),
                ('panel_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_PANELTYPE_MODEL)),
            ],
            options={
                ...
                'unique_together': {('commitment', 'panel_location', 'panel_time', 'panel_type')},
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('judge', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('panel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_PANEL_MODEL)),
                ('viewers', models.ManyToManyField(db_table='accelerator_judgeapplicationfeedback_viewers', related_name='viewed_feedback', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('program_family', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_clearances', to=settings.ACCELERATOR_PROGRAMFAMILY_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_APPLICATION_MODEL)),
                ('application_question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_APPLICATIONQUESTION_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cycle', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='programs', to=settings.ACCELERATOR_PROGRAMCYCLE_MODEL)),
                ('mentor_program_group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.ACCELERATOR_NAMEDGROUP_MODEL)),
                ('program_family', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='programs', to=settings.ACCELERATOR_PROGRAMFAMILY_MODEL)),
            ],
            options={
        ...
        migrations.RunPython(
            code=accelerator.migrations.0008_migrate_old_location_data_to_new_location_field.migrate_office_hours_locations,
        ...
        migrations.RunPython(
            code=accelerator.migrations.0012_delete_unused_user_roles.delete_unused_user_roles,
            reverse_code=django.db.migrations.operations.special.RunPython.noop,
        ),
        ...
        migrations.AlterField(
            model_name='program',
            name='cycle',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='programs', to=settings.ACCELERATOR_PROGRAMCYCLE_MODEL),
        ),
        migrations.AlterField(
            model_name='program',
            name='end_date',
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='application_type_for', to=settings.ACCELERATOR_APPLICATIONTYPE_MODEL),
        ),
        migrations.AlterField(
            model_name='programcycle',
            name='short_name',
        ...
        migrations.RunPython(
            code=accelerator.migrations.0019_add_deferred_user_role.add_deferred_user_role,
            reverse_code=django.db.migrations.operations.special.RunPython.noop,
        ),
        migrations.AlterField(
            model_name='expertprofile',
            name='mentoring_specialties',
            field=models.ManyToManyField(blank=True, db_table='accelerator_expert_related_mentoringspecialty', help_text='Hold down "Control", or "Command" on a Mac,toselect more than one.', related_name='experts', to=settings.ACCELERATOR_MENTORINGSPECIALTIES_MODEL, verbose_name='Mentoring Specialties'),
        ),
        migrations.AddField(
            model_name='mentorprogramofficehour',
            name='startup',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='startup_officehours', to=settings.ACCELERATOR_STARTUP_MODEL),
        ),
        migrations.AlterField(
            model_name='mentorprogramofficehour',
            name='program',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.ACCELERATOR_PROGRAM_MODEL),
        ),
        migrations.AddField(
            model_name='mentorprogramofficehour',
            name='meeting_info',
        ...
        migrations.AlterModelOptions(
            name='Application',
            options={'abstract': False, 'db_table': 'accelerator_application', 'managed': True, 'ordering': ['startup'], 'swappable': None, 'verbose_name_plural': 'Applications'},
        ),
        migrations.AlterModelOptions(
            name='ApplicationAnswer',
            options={'abstract': False, 'db_table': 'accelerator_applicationanswer', 'managed': True, 'swappable': None, 'verbose_name_plural': 'Application Answers'},
        ),
        migrations.AlterModelOptions(
            name='ApplicationPanelAssignment',
            options={'abstract': False, 'db_table': 'accelerator_applicationpanelassignment', 'managed': True, 'ordering': ('panel_slot_number',), 'swappable': None, 'verbose_name_plural': 'assignments of startup applications to panel'},
        ),
        migrations.AlterModelOptions(
            name='ApplicationQuestion',
            options={'abstract': False, 'managed': True, 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='ApplicationType',
            options={'abstract': False, 'managed': True, 'swappable': None},
        ...
        migrations.AlterModelOptions(
            name='BaseProfile',
            options={'abstract': False, 'db_table': 'accelerator_baseprofile', 'managed': True, 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='BucketState',
            options={'abstract': False, 'db_table': 'accelerator_bucketstate', 'managed': True, 'ordering': ['sort_order'], 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='CategoryHeaderPage',
            options={'abstract': False, 'db_table': 'pagetype_accelerator_categoryheaderpage', 'managed': True, 'manager_inheritance_from_future': True, 'swappable': None, 'verbose_name': 'Category Header', 'verbose_name_plural': 'Category Headers'},
        ),
        migrations.AlterModelOptions(
            name='Clearance',
            options={'abstract': False, 'db_table': 'accelerator_clearance', 'managed': True, 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='Criterion',
            options={'abstract': False, 'db_table': 'accelerator_criterion', 'managed': True, 'swappable': None, 'verbose_name': 'Application Allocator Criterion', 'verbose_name_plural': 'Application Allocator Criteria'},
        ),
        migrations.AlterModelOptions(
            name='CriterionOptionSpec',
            options={'abstract': False, 'db_table': 'accelerator_criterionoptionspec', 'managed': True, 'swappable': None, 'verbose_name': 'Application Allocator Criterion Option'},
        ),
        migrations.AlterModelOptions(
            name='Currency',
            options={'abstract': False, 'db_table': 'accelerator_currency', 'managed': True, 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='EntrepreneurProfile',
            options={'abstract': False, 'db_table': 'accelerator_entrepreneurprofile', 'managed': True, 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='ExpertCategory',
            options={'abstract': False, 'db_table': 'accelerator_expertcategory', 'managed': True, 'ordering': ['name'], 'swappable': None, 'verbose_name': 'Expert Category', 'verbose_name_plural': 'Expert Categories'},
        ),
        migrations.AlterModelOptions(
            name='ExpertInterest',
            options={'abstract': False, 'db_table': 'accelerator_expertinterest', 'managed': True, 'swappable': None, 'verbose_name_plural': 'Expert Interests'},
        ),
        migrations.AlterModelOptions(
            name='ExpertInterestType',
            options={'abstract': False, 'db_table': 'accelerator_expertinteresttype', 'managed': True, 'swappable': None, 'verbose_name_plural': 'Expert Interest Types'},
        ),
        migrations.AlterModelOptions(
            name='ExpertProfile',
            options={'abstract': False, 'db_table': 'accelerator_expertprofile', 'managed': True, 'permissions': (('change_password', 'Can change users passwords directly'),), 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='FilePage',
            options={'abstract': False, 'db_table': 'pagetype_accelerator_filepage', 'managed': True, 'manager_inheritance_from_future': True, 'swappable': None, 'verbose_name': 'File', 'verbose_name_plural': 'Files'},
        ),
        migrations.AlterModelOptions(
            name='FunctionalExpertise',
            options={'abstract': False, 'db_table': 'accelerator_functionalexpertise', 'managed': True, 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='Industry',
            options={'abstract': False, 'db_table': 'accelerator_industry', 'swappable': None, 'verbose_name_plural': 'Industries'},
        ),
        migrations.AlterModelOptions(
            name='InterestCategory',
            options={'abstract': False, 'db_table': 'accelerator_interestcategory', 'managed': True, 'swappable': None, 'verbose_name_plural': 'Interest Categories'},
        ),
        migrations.AlterModelOptions(
            name='JobPosting',
            options={'abstract': False, 'db_table': 'accelerator_jobposting', 'managed': True, 'swappable': None, 'verbose_name_plural': 'Job postings for startups'},
        ),
        migrations.AlterModelOptions(
            name='JudgeApplicationFeedback',
            options={'abstract': False, 'db_table': 'accelerator_judgeapplicationfeedback', 'managed': True, 'swappable': None, 'verbose_name_plural': 'Judge Application Feedback'},
        ),
        migrations.AlterModelOptions(
            name='JudgeAvailability',
            options={'abstract': False, 'db_table': 'accelerator_judgeavailability', 'managed': True, 'ordering': ['panel_time__start_date_time', 'panel_type__panel_type', 'panel_location__location'], 'swappable': None, 'verbose_name_plural': 'Judge availability for specific Panel types, times, locations'},
        ),
        migrations.AlterModelOptions(
            name='JudgeFeedbackComponent',
            options={'abstract': False, 'db_table': 'accelerator_judgefeedbackcomponent', 'managed': True, 'swappable': None, 'verbose_name_plural': 'Feedback Components'},
        ),
        migrations.AlterModelOptions(
            name='JudgePanelAssignment',
            options={'abstract': False, 'db_table': 'accelerator_judgepanelassignment', 'managed': True, 'swappable': None, 'verbose_name_plural': 'assignments of judge to panel'},
        ),
        migrations.AlterModelOptions(
            name='JudgeRoundCommitment',
            options={'abstract': False, 'db_table': 'accelerator_judgeroundcommitment', 'managed': True, 'swappable': None, 'verbose_name_plural': 'Judge commitment to participate in a Judging Round'},
        ),
        migrations.AlterModelOptions(
            name='JudgingForm',
            options={'abstract': False, 'db_table': 'accelerator_judgingform', 'managed': True, 'swappable': None, 'verbose_name_plural': 'Judging Forms'},
        ),
        migrations.AlterModelOptions(
            name='JudgingFormElement',
            options={'abstract': False, 'db_table': 'accelerator_judgingformelement', 'managed': True, 'ordering': ['form_type', 'element_number'], 'swappable': None, 'verbose_name_plural': 'Judging Form Elements'},
        ),
        migrations.AlterModelOptions(
            name='JudgingRound',
            options={'abstract': False, 'db_table': 'accelerator_judginground', 'managed': True, 'ordering': ['program__program_status', '-program__end_date', '-end_date_time', 'name'], 'swappable': None, 'verbose_name_plural': 'Judging Rounds'},
        ),
        migrations.AlterModelOptions(
            name='LegalCheck',
            options={'abstract': False, 'db_table': 'accelerator_legalcheck', 'managed': True, 'swappable': None, 'verbose_name': 'Legal Check'},
        ),
        migrations.AlterModelOptions(
            name='Location',
            options={'abstract': False, 'db_table': 'accelerator_location', 'managed': True, 'swappable': None, 'verbose_name_plural': 'locations'},
        ),
        migrations.AlterModelOptions(
            name='MemberProfile',
            options={'abstract': False, 'db_table': 'accelerator_memberprofile', 'managed': True, 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='MentoringSpecialties',
            options={'abstract': False, 'db_table': 'accelerator_mentoringspecialties', 'managed': True, 'ordering': ['name'], 'swappable': None, 'verbose_name': 'Mentoring Specialty', 'verbose_name_plural': 'Mentoring Specialties'},
        ),
        migrations.AlterModelOptions(
            name='MentorProgramOfficeHour',
            options={'abstract': False, 'db_table': 'accelerator_mentorprogramofficehour', 'managed': True, 'ordering': ['start_date_time'], 'swappable': None, 'verbose_name': 'Office Hour'},
        ),
        migrations.AlterModelOptions(
            name='ModelChange',
            options={'abstract': False, 'db_table': 'accelerator_modelchange', 'managed': True, 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='NamedGroup',
            options={'abstract': False, 'db_table': 'accelerator_namedgroup', 'managed': True, 'ordering': ['name'], 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='NavTree',
            options={'abstract': False, 'db_table': 'accelerator_navtree', 'managed': True, 'swappable': None, 'verbose_name_plural': 'NavTrees'},
        ),
        migrations.AlterModelOptions(
            name='NavTreeItem',
            options={'abstract': False, 'db_table': 'accelerator_navtreeitem', 'managed': True, 'swappable': None, 'verbose_name_plural': 'NavTreeItems'},
        ),
        migrations.AlterModelOptions(
            name='Newsletter',
            options={'abstract': False, 'db_table': 'accelerator_newsletter', 'managed': True, 'ordering': ('-created_at', 'name'), 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='NewsletterReceipt',
            options={'abstract': False, 'db_table': 'accelerator_newsletterreceipt', 'managed': True, 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='NodePublishedFor',
            options={'abstract': False, 'db_table': 'accelerator_nodepublishedfor', 'managed': True, 'swappable': None, 'verbose_name': 'Node is Published For', 'verbose_name_plural': 'Node is Published For'},
        ),
        migrations.AlterModelOptions(
            name='NodeSubNavAssociation',
            options={'abstract': False, 'db_table': 'accelerator_nodesubnavassociation', 'managed': True, 'swappable': None, 'verbose_name': 'Node Sub Navigation Association', 'verbose_name_plural': 'Node Sub Navigation Associations'},
        ),
        migrations.AlterModelOptions(
            name='Observer',
            options={'abstract': False, 'db_table': 'accelerator_observer', 'managed': True, 'ordering': ['last_name', 'first_name'], 'swappable': None, 'verbose_name': 'Observer', 'verbose_name_plural': 'Observers'},
        ),
        migrations.AlterModelOptions(
            name='Organization',
            options={'abstract': False, 'db_table': 'accelerator_organization', 'managed': True, 'ordering': ['name'], 'swappable': None, 'verbose_name_plural': 'Organizations'},
        ),
        migrations.AlterModelOptions(
            name='Panel',
            options={'abstract': False, 'db_table': 'accelerator_panel', 'managed': True, 'swappable': None, 'verbose_name_plural': 'Panels'},
        ),
        migrations.AlterModelOptions(
            name='PanelLocation',
            options={'abstract': False, 'db_table': 'accelerator_panellocation', 'managed': True, 'ordering': ['judging_round', 'description'], 'swappable': None, 'verbose_name_plural': 'Panel Locations'},
        ),
        migrations.AlterModelOptions(
            name='PanelTime',
            options={'abstract': False, 'db_table': 'accelerator_paneltime', 'managed': True, 'ordering': ['judging_round', 'start_date_time'], 'swappable': None, 'verbose_name_plural': 'Panel Times'},
        ),
        migrations.AlterModelOptions(
            name='PanelType',
            options={'abstract': False, 'db_table': 'accelerator_paneltype', 'managed': True, 'ordering': ['judging_round', 'description'], 'swappable': None, 'verbose_name_plural': 'Panel Types'},
        ),
        migrations.AlterModelOptions(
            name='Partner',
            options={'abstract': False, 'db_table': 'accelerator_partner', 'managed': True, 'ordering': ['organization__name'], 'swappable': None, 'verbose_name_plural': 'Partners'},
        ),
        migrations.AlterModelOptions(
            name='PartnerTeamMember',
            options={'abstract': False, 'db_table': 'accelerator_partnerteammember', 'managed': True, 'ordering': ['team_member__last_name', 'team_member__first_name'], 'swappable': None, 'verbose_name_plural': 'Partner Team Members'},
        ),
        migrations.AlterModelOptions(
            name='PayPalPayment',
            options={'abstract': False, 'db_table': 'accelerator_paypalpayment', 'managed': True, 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='PayPalRefund',
            options={'abstract': False, 'db_table': 'accelerator_paypalrefund', 'managed': True, 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='Program',
            options={'abstract': False, 'db_table': 'accelerator_program', 'managed': True, 'swappable': None, 'verbose_name_plural': 'Programs'},
        ),
        migrations.AlterModelOptions(
            name='ProgramCycle',
            options={'abstract': False, 'db_table': 'accelerator_programcycle', 'managed': True, 'swappable': None, 'verbose_name_plural': 'program cycles'},
        ),
        migrations.AlterModelOptions(
            name='ProgramFamily',
            options={'abstract': False, 'db_table': 'accelerator_programfamily', 'managed': True, 'swappable': None, 'verbose_name_plural': 'program families'},
        ),
        migrations.AlterModelOptions(
            name='ProgramFamilyLocation',
            options={'abstract': False, 'db_table': 'accelerator_programfamilylocation', 'managed': True, 'swappable': None, 'verbose_name': 'Program Family Location', 'verbose_name_plural': 'Program Family Locations'},
        ),
        migrations.AlterModelOptions(
            name='ProgramOverride',
            options={'abstract': False, 'db_table': 'accelerator_programoverride', 'managed': True, 'swappable': None, 'verbose_name_plural': 'Program Overrides'},
        ),
        migrations.AlterModelOptions(
            name='ProgramPartner',
            options={'abstract': False, 'db_table': 'accelerator_programpartner', 'managed': True, 'ordering': ['program__name', 'partner_type__sort_order', 'partner'], 'swappable': None, 'verbose_name_plural': 'Program Partner'},
        ),
        migrations.AlterModelOptions(
            name='ProgramPartnerType',
            options={'abstract': False, 'db_table': 'accelerator_programpartnertype', 'managed': True, 'ordering': ['program', 'sort_order'], 'swappable': None, 'verbose_name_plural': 'Program Partner Types'},
        ),
        migrations.AlterModelOptions(
            name='ProgramRole',
            options={'abstract': False, 'db_table': 'accelerator_programrole', 'managed': True, 'ordering': ['name'], 'swappable': None, 'verbose_name': 'Program Role', 'verbose_name_plural': 'Program Roles'},
        ),
        migrations.AlterModelOptions(
            name='ProgramRoleGrant',
            options={'abstract': False, 'db_table': 'accelerator_programrolegrant', 'managed': True, 'swappable': None, 'verbose_name': 'Program Role Grant', 'verbose_name_plural': 'Program Role Grants'},
        ),
        migrations.AlterModelOptions(
            name='ProgramStartupAttribute',
            options={'abstract': False, 'db_table': 'accelerator_programstartupattribute', 'managed': True, 'ordering': ['program', 'attribute_label'], 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='ProgramStartupStatus',
            options={'abstract': False, 'db_table': 'accelerator_programstartupstatus', 'managed': True, 'ordering': ['program', 'sort_order', 'startup_status'], 'swappable': None, 'verbose_name_plural': 'Program Startup Statuses'},
        ),
        migrations.AlterModelOptions(
            name='Question',
            options={'abstract': False, 'db_table': 'accelerator_question', 'managed': True, 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='Reference',
            options={'abstract': False, 'managed': True, 'swappable': None},
        ...
        migrations.AlterModelOptions(
            name='RefundCode',
            options={'abstract': False, 'db_table': 'accelerator_refundcode', 'managed': True, 'swappable': None, 'verbose_name_plural': 'Refund Codes'},
        ),
        migrations.AlterModelOptions(
            name='RefundCodeRedemption',
            options={'abstract': False, 'db_table': 'accelerator_refundcoderedemption', 'managed': True, 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='Scenario',
            options={'abstract': False, 'db_table': 'accelerator_scenario', 'managed': True, 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='ScenarioApplication',
            options={'abstract': False, 'db_table': 'accelerator_scenarioapplication', 'managed': True, 'swappable': None, 'verbose_name_plural': 'Scenario Applications'},
        ),
        migrations.AlterModelOptions(
            name='ScenarioJudge',
            options={'abstract': False, 'db_table': 'accelerator_scenariojudge', 'managed': True, 'swappable': None, 'verbose_name_plural': 'Scenario Judges'},
        ),
        migrations.AlterModelOptions(
            name='ScenarioPreference',
            options={'abstract': False, 'db_table': 'accelerator_scenariopreference', 'managed': True, 'ordering': ['priority'], 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='Section',
            options={'abstract': False, 'db_table': 'accelerator_section', 'managed': True, 'ordering': ('newsletter', 'sequence'), 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='Site',
            options={'abstract': False, 'db_table': 'accelerator_site', 'managed': True, 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='SiteProgramAuthorization',
            options={'abstract': False, 'db_table': 'accelerator_siteprogramauthorization', 'managed': True, 'swappable': None, 'verbose_name_plural': 'Site Program Authorizations'},
        ),
        migrations.AlterModelOptions(
            name='SiteRedirectPage',
            options={'abstract': False, 'db_table': 'pagetype_accelerator_siteredirectpage', 'managed': True, 'manager_inheritance_from_future': True, 'swappable': None, 'verbose_name': 'Site Redirect', 'verbose_name_plural': 'Site Redirects'},
        ),
        migrations.AlterModelOptions(
            name='Startup',
            options={'abstract': False, 'db_table': 'accelerator_startup', 'managed': True, 'ordering': ['organization__name'], 'swappable': None, 'verbose_name_plural': 'Startups'},
        ),
        migrations.AlterModelOptions(
            name='StartupAttribute',
            options={'abstract': False, 'db_table': 'accelerator_startupattribute', 'managed': True, 'swappable': None, 'verbose_name_plural': 'Startup Attributes'},
        ),
        migrations.AlterModelOptions(
            name='StartupCycleInterest',
            options={'abstract': False, 'db_table': 'accelerator_startupcycleinterest', 'managed': True, 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='StartupLabel',
            options={'abstract': False, 'managed': True, 'swappable': None},
        ...
        migrations.AlterModelOptions(
            name='StartupMentorRelationship',
            options={'abstract': False, 'db_table': 'accelerator_startupmentorrelationship', 'managed': True, 'swappable': None, 'verbose_name_plural': 'Startup Mentor Relationships'},
        ),
        migrations.AlterModelOptions(
            name='StartupMentorTrackingRecord',
            options={'abstract': False, 'db_table': 'accelerator_startupmentortrackingrecord', 'managed': True, 'swappable': None, 'verbose_name': 'Mentor Tracking Record', 'verbose_name_plural': 'Mentor Tracking Records'},
        ),
        migrations.AlterModelOptions(
            name='StartupOverrideGrant',
            options={'abstract': False, 'db_table': 'accelerator_startupoverridegrant', 'managed': True, 'swappable': None, 'verbose_name_plural': 'Startup Override Grants'},
        ),
        migrations.AlterModelOptions(
            name='StartupProgramInterest',
            options={'abstract': False, 'db_table': 'accelerator_startupprograminterest', 'managed': True, 'ordering': ['order'], 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='StartupRole',
            options={'abstract': False, 'db_table': 'accelerator_startuprole', 'managed': True, 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='StartupStatus',
            options={'abstract': False, 'db_table': 'accelerator_startupstatus', 'managed': True, 'swappable': None, 'verbose_name_plural': 'Startup Statuses'},
        ),
        migrations.AlterModelOptions(
            name='StartupTeamMember',
            options={'abstract': False, 'db_table': 'accelerator_startupteammember', 'managed': True, 'swappable': None, 'verbose_name_plural': 'Startup Team Members'},
        ),
        migrations.AlterModelOptions(
            name='UserLabel',
            options={'abstract': False, 'db_table': 'accelerator_userlabel', 'managed': True, 'ordering': ['label'], 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='UserLegalCheck',
            options={'abstract': False, 'db_table': 'accelerator_userlegalcheck', 'managed': True, 'swappable': None, 'verbose_name': 'User Legal Check'},
        ),
        migrations.AlterModelOptions(
            name='UserRole',
            options={'abstract': False, 'db_table': 'accelerator_userrole', 'managed': True, 'swappable': None},
        ),
        migrations.AlterModelOptions(
            name='UserRoleMenu',
            options={'abstract': False, 'db_table': 'pagetype_accelerator_userrolemenu', 'managed': True, 'manager_inheritance_from_future': True, 'swappable': None, 'verbose_name': 'User Role Menu', 'verbose_name_plural': 'User Role Menus'},
        ),
        migrations.AlterModelOptions(
            name='Allocator',
            options={'abstract': False, 'db_table': 'accelerator_allocator', 'managed': True, 'swappable': None, 'verbose_name_plural': 'Allocators'},
        ),
        migrations.AddField(
        ...
        migrations.RunPython(
            code=accelerator.migrations.0029_add_gender_choices_data.add_gender_choices,
            reverse_code=django.db.migrations.operations.special.RunPython.noop,
        ),
        migrations.AddField(
            model_name='entrepreneurprofile',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, to=settings.ACCELERATOR_GENDERCHOICES_MODEL),
        ),
        migrations.AddField(
            model_name='expertprofile',
            name='gender_self_description',
        ...
        migrations.RunPython(
            code=accelerator.migrations.0032_add_ethno_racial_identity_data.add_ethno_racial_identity_data,
            reverse_code=django.db.migrations.operations.special.RunPython.noop,
        ),
        migrations.RunPython(
            code=accelerator.migrations.0033_migrate_gender_data.migrate_gender_data_to_gender_identity,
        ),
    ]
